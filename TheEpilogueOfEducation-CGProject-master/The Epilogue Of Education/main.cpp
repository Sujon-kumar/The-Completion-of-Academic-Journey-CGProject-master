...
void introduction() {
	...
	// Story Title
	print("The Completion of Academic Journey",
		1, 1, 1, title_fade, 280, 380, .3, .3, 2);

	print("by Sujon Kumar",
...
void EC_drawBoard() {
	...
	print("Noakhali Science And Technology University",
		1, 1, 1, 1,
		530, 715,
		.1, .1,
		1);

	print("Affiliated to UGC, Bangladesh",
		1, 1, 1, 1,
		590, 695,
		.08, .08,
		1);
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("The Completion of Academic Journey");
